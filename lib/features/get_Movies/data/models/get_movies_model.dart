...
//
//     final getMoviesModelClass = getMoviesModelClassFromJson(jsonString);

import 'dart:convert';

List<GetMoviesModelClass> getMoviesModelClassFromJson(String str) =>
    List<GetMoviesModelClass>.from(
        json.decode(str).map((x) => GetMoviesModelClass.fromJson(x)));

/*String getMoviesModelClassToJson(List<GetMoviesModelClass> data) =>
    json.encode(List<dynamic>.from(data.map((x) => x.toJson())));*/

class GetMoviesModelClass {
  double score;
  Show show;
  ...
  factory GetMoviesModelClass.fromJson(Map<String, dynamic> json) =>
      GetMoviesModelClass(
